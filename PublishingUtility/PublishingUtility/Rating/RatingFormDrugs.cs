...
{
	public class RatingFormDrugs : Form
	{
		...
		public RatingFormDrugs()
		{
			InitializeComponent();
			base.StartPosition = FormStartPosition.CenterScreen;
			if (Program._RatingData.IsDrugsQ01)
			{
			...
			if (Program._RatingData.IsDrugsQ02)
			{
			...
			if (Program._RatingData.IsDrugsQ03)
			{
		...
		private void buttonNext_Click(object sender, EventArgs e)
		{
			...
			{
				Program._RatingData.IsDrugsQ01 = true;
			}
			else
			{
				Program._RatingData.IsDrugsQ01 = false;
			}
			if (radioButton02Yes.Checked)
			{
				Program._RatingData.IsDrugsQ02 = true;
			}
			else
			{
				Program._RatingData.IsDrugsQ02 = false;
			}
			if (radioButton03Yes.Checked)
			{
				Program._RatingData.IsDrugsQ03 = true;
			}
			else
			{
				Program._RatingData.IsDrugsQ03 = false;
			}
		}

		private void RatingFormDrugs_FormClosing(object sender, FormClosingEventArgs e)
		{
		...
		{
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(PublishingUtility.Rating.RatingFormDrugs));
			...
			label1.Name = "label1";
			groupBox03.Controls.Add(label10);
			...
			base.Name = "RatingFormDrugs";
			base.FormClosing += new System.Windows.Forms.FormClosingEventHandler(RatingFormDrugs_FormClosing);
