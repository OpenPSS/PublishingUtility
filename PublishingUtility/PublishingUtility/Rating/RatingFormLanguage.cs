...
{
	public class RatingFormLanguage : Form
	{
		...
		public RatingFormLanguage()
		{
			InitializeComponent();
			base.StartPosition = FormStartPosition.CenterScreen;
			if (Program._RatingData.IsLanguageQ01)
			{
			...
			if (Program._RatingData.IsLanguageQ02)
			{
		...
		private void buttonNext_Click(object sender, EventArgs e)
		{
			...
			{
				Program._RatingData.IsLanguageQ01 = true;
			}
			else
			{
				Program._RatingData.IsLanguageQ01 = false;
			}
			if (radioButton02Yes.Checked)
			{
				Program._RatingData.IsLanguageQ02 = true;
			}
			else
			{
				Program._RatingData.IsLanguageQ02 = false;
			}
		}

		private void RatingFormLanguage_FormClosing(object sender, FormClosingEventArgs e)
		{
		...
		{
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(PublishingUtility.Rating.RatingFormLanguage));
			...
			base.Name = "RatingFormLanguage";
			base.FormClosing += new System.Windows.Forms.FormClosingEventHandler(RatingFormLanguage_FormClosing);
